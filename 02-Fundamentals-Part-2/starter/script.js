...
Hints: Call ‘calcTip tips and totals arrays 😉 ‘in the loop and use the push method to add values to the tips and totals arrays 😉
...
console.log(`Total bill + tips: ${totals}`);
/* 
Bonus:
4. Bonus: Write a function 'calcAverage' which takes an array called 'arr' as an argument. This function calculates the average of all numbers in the given array. This is a difficult challenge (we haven't done this before)! Here is how to solve it:
...
console.log(`The total average bill + tip is ${calcAverage(totals)}`);
